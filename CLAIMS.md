...
- **`open` rows cite no evidence, by definition.** They are questions the project intends to
  ...
  experiment that would populate it. C-35, C-53 and C-54 are the current set; C-50 was
  answered by T1.4 (answer C-55), C-51 by T1.1 (answer C-56), and C-52 by T1.2 (no hysteresis; corroborates C-26/C-56). An `open` row may never be quoted as a claim.
