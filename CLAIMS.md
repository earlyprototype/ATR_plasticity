...
| ID | Question | Where |
|---|---|---|
| **C-35** | Does coupling grow with drift? | **Answered by T2.1: it grows, monotone on all three axes, and never changes the outcome inside the ceiling-silent range.** Durable claim C-58. Evidence: `experiments/output_t2_1/` |
