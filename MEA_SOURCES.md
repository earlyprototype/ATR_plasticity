...
| Chao, Bakkum and Potter (2007), Journal of Neural Engineering 4(3):294-308 | Defining equations for the centre of activity and its trajectory; the shuffled-position control and its reported sensitivities (detectable change 4.68% against 10.8% shuffled, sensitivity 88.7% against 35.4%); the change-to-drift definition; the companion measure over connection strengths | Quoted from the retrieved reprint. This is the source EXP-003 draws on most |
...
| Wagenaar, Nadasdy and Potter (2006), Physical Review E 73:051907 | Title, authors, journal | Contents not used |
